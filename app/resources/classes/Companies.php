...
class Companies
{
    ...
    {
        global $mysqli;
        $this->data = $mysqli->query("SELECT * FROM wf_companies")->fetch_all(MYSQLI_ASSOC);
        return $this->data;
    }
    ...
    {
        global $mysqli;
        $this->data = $mysqli->query("SELECT * FROM wf_companies WHERE id =" . $id)->fetch_all(MYSQLI_ASSOC);
        return $this->data;
    }
    ...
    {
        global $mysqli;
        $this->data = $mysqli->query("INSERT INTO wf_companies (name, legal_address, actual_address, telephones, code, tax_number, certificate_number,
...
VALUES 
    ...
    {
        global $mysqli;
        $this->data = $mysqli->query("UPDATE wf_companies SET name = '$name', legal_address = '$legal_address', actual_address = '$actual_address', telephones = '$telephones',
...
additional_field_1 = '$additional_field_1', additional_field_2 = '$additional_field_2', additional_field_3 = '$additional_field_3', additional_field_4 = '$additional_field_4' WHERE id =".$id);
    ...
    {
        global $mysqli;
        $this->data = $mysqli->query("DELETE FROM wf_companies WHERE id =" . $id);
        return $this->data;
    }
}