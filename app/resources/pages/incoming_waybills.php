            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <div class="row">
                                <div class="col-9"><h2><strong>Прибуткові накладні</strong></h2></div>
                                <div class="col-3"><a href="?page=create_incoming_waybill"
                                                      class="btn btn-primary float-right"><i
                                            class="zmdi zmdi-plus-circle-o"></i>&nbsp;Створити</a></div>
                            </div>
                        </div>
                        <div class="body">
                            <h5>Прибуткові накладні</h5>
                                            ...
                                            <td nowrap>
                                                <div class="btn-group btn-group-justified">
                                                    <?php if ($waybill[$i]['finalize'] == 0) { ?>
                                                        <a href="/?page=edit_incoming_waybill&id=<?php echo $waybill[$i]['id']; ?>"
...
<script type="text/javascript">
    function download_waybill(id) {
        ...
        $.post('/app/resources/services/doc/incoming_waybill_generate.php', {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    let async = "delete_incoming_waybill";
                    $.ajax({
