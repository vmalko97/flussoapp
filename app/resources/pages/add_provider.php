            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Додати постачальника</li>
                    </ul>
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h5><strong>Додати</strong> постачальника</h5>
                        </div>
                        <div class="body">
                            <h2 class="card-inside-title">Додати постачальника</h2>
                            <div class="row clearfix">
                                <div class="col-sm-12">
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data === "error") {
                    ...
                    swal({
                        title: "Успіх",
                        text: "Постачальника додано успішно",
                        icon: "success",
                    });
                } else {
                    swal({
