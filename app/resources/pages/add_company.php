            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Додати підприємство</li>
                    </ul>
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h5><strong>Додати</strong> підприємство</h5>
                        </div>
                        <div class="body">
                            <h2 class="card-inside-title">Додати підприємство</h2>
                            <div class="row clearfix">
                                <div class="col-sm-12">
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data === "error") {
                    swal({
                        title: "Помилка",
                        text: "Не вдалося додати компанію",
                        icon: "error",
                    });
                } else if (data === "success") {
                    swal({
                        title: "Успіх",
                        text: "Компанію додано успішно",
                        icon: "success",
                    });
                } else {
                    swal({
