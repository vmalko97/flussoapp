            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Інформація про клієнта</li>
                    </ul>
            ...
            <div class="row clearfix">
                ...
                if (empty($id) || !isset($id)) {
                    echo " <div class='col-lg-12 col-md-12'>
                           ...
                           <div class='body'>
                                <h2 class='card-inside-title'>Інформація про клієнта</h2>
                                <div class='alert alert-danger'>Помилка! Не обрано клієнта для перегляду.</div>
                            </div>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card mcard_3">
                        <div class="body">
                            <h4 class="m-t-10"><?php echo htmlspecialchars($customer[$i]['name']); ?></h4>
                            <div class="row">
                                <div class="col-12">
                                    <p class="text-black"><strong>Юридична адреса:</strong></p>
                                    <p class="text-muted"><?php echo htmlspecialchars($customer[$i]['legal_address']); ?></p>
                                </div>
                                <div class="col-12">
                                    <p class="text-black"><strong>Фактична адреса:</strong></p>
                                    <p class="text-muted"><?php echo htmlspecialchars($customer[$i]['actual_address']); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="body">
                            ...
                            <p><?php echo htmlspecialchars($customer[$i]['email']); ?></p>
                            <hr>
                            <small class="text-muted">Телефони: </small>
                            <p><?php echo htmlspecialchars($customer[$i]['telephones']); ?></p>
                            <hr>
                            <small class="text-muted">Web-сайт: </small>
                            <p><?php echo htmlspecialchars($customer[$i]['website']); ?></p>
                            <hr>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="body">
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <p><?php echo htmlspecialchars($customer[$i]['code']); ?></p>
                                        <hr>
                                    </div>
                                    <div class="col-sm-4">
                                        <small class="text-muted">РНОКПП (ІПН): </small>
                                        <p><?php echo htmlspecialchars($customer[$i]['tax_number']); ?></p>
                                        <hr>
                                    </div>
                                    <div class="col-sm-4">
                                        <small class="text-muted">Номер свідоцтва: </small>
                                        <p><?php echo htmlspecialchars($customer[$i]['certificate_number']); ?></p>
                                        <hr>
                                    </div>
                                    <div class="col-sm-6">
                                        <small class="text-muted">Директор: </small>
                                        <p><?php echo htmlspecialchars($customer[$i]['director']); ?></p>
                                        <hr>
                                    </div>
                                    <div class="col-sm-6">
                                        <small class="text-muted">Головний бухгалтер: </small>
                                        <p><?php echo htmlspecialchars($customer[$i]['chief_accountant']); ?></p>
                                        <hr>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="body">
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <p><?php echo htmlspecialchars($customer[$i]['current_account']); ?></p>
                                        <hr>
                                    </div>
                                    <div class="col-sm-4">
                                        <small class="text-muted">МФО банку: </small>
                                        <p><?php echo htmlspecialchars($customer[$i]['bank_code']); ?></p>
                                        <hr>
                                    </div>
                                    <div class="col-sm-4">
                                        <small class="text-muted">Найменування банку: </small>
                                        <p><?php echo htmlspecialchars($customer[$i]['bank_name']); ?></p>
                                        <hr>
                                    </div>
                                    <div class="col-sm-6">
                                        <small class="text-muted">Вид цивільно-правового договору: </small>
                                        <p><?php
                                            $civil_contract_type = htmlspecialchars($customer[$i]['civil_contract_type']);
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <p><?php
                                            $vat = htmlspecialchars($customer[$i]['vat']);
                                            switch ($vat){
                                                case 0:
                            ...
                            <div class="body">
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <p><?php
                                            $additional_field_0 = htmlspecialchars($customer[$i]['additional_field_0']);
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <p><?php
                                            $additional_field_1 = htmlspecialchars($customer[$i]['additional_field_1']);
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <p><?php
                                            $additional_field_2 = htmlspecialchars($customer[$i]['additional_field_2']);
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <p><?php
                                            $additional_field_3 = htmlspecialchars($customer[$i]['additional_field_3']);
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <p><?php
                                            $additional_field_4 = htmlspecialchars($customer[$i]['additional_field_4']);
