            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Створити рахунок-фактуру</li>
                    </ul>
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Створити рахунок-фактуру</strong></h2>
                        </div>
                        <div class="body">
                            <h5>Створити рахунок-фактуру</h5>
                            <div class="row clearfix">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" name="written_by" value="<?php echo $written_by; ?>"/>
                                </div>
                                <div class="col-md-12">
                                    <hr/>
                                    <div class="checkbox">
                                ...
                                <div class="col-md-6">
                                    <button class="btn btn-block btn-primary" onclick="create_only_invoice()">Створити
                                        тільки рахунок
                                    </button>
                                </div>
                                <div class="col-md-6">
                                    <button class="btn btn-block btn-success" onclick="create_invoice_and_waybill()">Створити комплект (рахунок+накладна)
                                    </button>
                                </div>
                            </div>
                        </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (dataObj.response === "error") {
                    ...
                    swal({
                        title: "Успіх",
                        text: "Рахунок створено успішно",
                        icon: "success",
                    });
                    location.assign(dataObj.download);
                    $.post('/temp/clear.php',{temp: dataObj.tempFile});
                    setTimeout(() => location.replace('/?page=invoices'), 3000);
                } else {
                    swal({
                        title: "Помилка",
                        text: "Спроба взлому",
...
function create_invoice_and_waybill(){
    let provider = $('select[name=provider]').val();
    let customer = $('select[name=customer]').val();
    let payer = $('select[name=payer]').val();
    let same = null;
    ...
    let async = "generate_invoice_and_waybill";
    $.ajax({
        url: "/app/resources/services/doc/invoice_generate.php",
        type: "POST",
        data:
