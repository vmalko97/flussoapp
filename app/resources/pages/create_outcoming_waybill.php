            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Створити видаткову накладну</li>
                    </ul>
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Створити видаткову накладну</strong></h2>
                        </div>
                        <div class="body">
                            <h5>Створити видаткову накладну</h5>
                            <div class="row clearfix">
                                <div class="col-md-12">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (dataObj.response === "error") {
                    ...
                    swal({
                        title: "Успіх",
                        text: "Видаткову накладну створено успішно",
                        icon: "success",
                    });
                    location.assign(dataObj.download);
                    $.post('/temp/clear.php',{temp: dataObj.tempFile});
                    setTimeout(() => location.replace('/?page=outcoming_waybills'), 3000);
                } else {
                    swal({
                        title: "Помилка",
                        text: "Спроба взлому",
