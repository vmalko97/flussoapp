            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Редагувати постачальника</li>
                    </ul>
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h5><strong>Редагувати</strong> постачальника</h5>
                        </div>
                        <?php
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input type="text" name="name" class="form-control"
                                               placeholder="Найменування / ПІБ" value="<?php echo htmlspecialchars($provider[$i]['name']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" name="legal_address" class="form-control"
                                               placeholder="Юридична адреса" value="<?php echo htmlspecialchars($provider[$i]['legal_address']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" name="actual_address" class="form-control"
                                               placeholder="Фактична адреса" value="<?php echo htmlspecialchars($provider[$i]['actual_address']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" name="telephones" class="form-control"
                                               placeholder="Телефони" value="<?php echo htmlspecialchars($provider[$i]['telephones']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <input type="text" name="code" class="form-control" placeholder="ЄДРПОУ" value="<?php echo htmlspecialchars($provider[$i]['code']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <input type="text" name="tax_number" class="form-control"
                                               placeholder="РНОКПП (ІПН)" value="<?php echo htmlspecialchars($provider[$i]['tax_number']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" name="certificate_number" class="form-control"
                                               placeholder="№ свідоцтва" value="<?php echo htmlspecialchars($provider[$i]['certificate_number']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <input type="text" name="director" class="form-control" placeholder="Директор" value="<?php echo htmlspecialchars($provider[$i]['director']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <input type="text" name="chief_accountant" class="form-control"
                                               placeholder="Головний бухалтер" value="<?php echo htmlspecialchars($provider[$i]['chief_accountant']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <input type="text" name="current_account" class="form-control"
                                               placeholder="Поточний рахунок (IBAN)" value="<?php echo htmlspecialchars($provider[$i]['current_account']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <input type="text" name="bank_code" class="form-control"
                                               placeholder="МФО Банку" value="<?php echo htmlspecialchars($provider[$i]['bank_code']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <input type="text" name="bank_name" class="form-control"
                                               placeholder="Найменування банку" value="<?php echo htmlspecialchars($provider[$i]['bank_name']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <input type="text" name="civil_contract_type" class="form-control"
                                               placeholder="Вид цивільно-правового договору" value="<?php echo htmlspecialchars($provider[$i]['civil_contract_type']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <input type="text" name="vat" class="form-control" placeholder="ПДВ" value="<?php echo htmlspecialchars($provider[$i]['vat']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <input type="text" name="email" class="form-control" placeholder="E-Mail" value="<?php echo htmlspecialchars($provider[$i]['email']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <input type="text" name="website" class="form-control" placeholder="Web-сайт" value="<?php echo htmlspecialchars($provider[$i]['website']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input type="text" name="additional_field_0" class="form-control"
                                               placeholder="Додаткове поле 1" value="<?php echo htmlspecialchars($provider[$i]['additional_field_0']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input type="text" name="additional_field_1" class="form-control"
                                               placeholder="Додаткове поле 2" value="<?php echo htmlspecialchars($provider[$i]['additional_field_1']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input type="text" name="additional_field_2" class="form-control"
                                               placeholder="Додаткове поле 3" value="<?php echo htmlspecialchars($provider[$i]['additional_field_2']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input type="text" name="additional_field_3" class="form-control"
                                               placeholder="Додаткове поле 4" value="<?php echo htmlspecialchars($provider[$i]['additional_field_3']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input type="text" name="additional_field_4" class="form-control"
                                               placeholder="Додаткове поле 5" value="<?php echo htmlspecialchars($provider[$i]['additional_field_4']); ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
